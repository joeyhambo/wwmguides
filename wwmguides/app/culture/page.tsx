  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Culture & Lore</h1>
        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          Explore the rich cultural tapestry behind Where Winds Meet. From Wuxia traditions to Chinese history and game lore.
        </p>
      </div>
